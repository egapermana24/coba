        ...
        <div class="row align-items-center">
            <div class="col-md-3">
                <select name="gender" class="custom-select">
                    ...
                    <option value="2" <?php if($Filter['gender']=='2' ) echo 'selected=""' ;?>><?php echo __('Male');?></option>
                    <option value="1" <?php if($Filter['gender']=='1' ) echo 'selected=""' ;?>><?php echo __('Female');?></option>
                </select>
            </div>
            <div class="col-md-3">
            ...
            <tr class="v-middle text-color">
                ...
                <td class="flex">
                    <a href="<?php echo APP.'/admin/'.$Config['page'].'/'.$Listing['id'];?>" class="text-color d-flex align-items-center">
                        <div class="media media-actor w-sm-thumb lazy" data-src="<?php echo $Listing['image']; ?>"></div>
                        <div class="ml-3">
                            <div class="title">
