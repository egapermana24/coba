        ...
        <div class="col-md-3">
            <div class="card card-statistic">
                <a href="" class="card-body">
                    ...
                    <div>
                        <div class="count"><?php echo $Total['store'];?></div> 
                        <div class="text"><?php echo __('Products');?></div>
                    </div>
                </a>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card card-statistic">
                <a href="" class="card-body">
                    ...
                    <div>
                        <div class="count"><?php echo count(scandir(ini_get("session.save_path"))) - 2; ?></div> 
                        <div class="text"><?php echo __('Users Online');?></div>
                    </div>
                </a>
            </div>
        </div>
