...
<li class="breadcrumb-item active"><a href="<?php echo APP.'/anime';?>"><?php echo __('Anime');?></a></li>
</ol>
</nav>
...
<a href="<?php if($Listing['type'] == 'serie') { echo APP. '/show/'; } else { echo '/movie/'; } echo $Listing['self'] . '-' . $Listing['create_year'];?>" class="list-media">
<?php if($Listing['quality'] || $Listing['imdb']) { ?>
<div class="list-media-attr">
<?php if($Listing['quality']) { ?><div class="quality"><?php echo $Listing['quality'];?></div><?php } ?>
<?php if($Listing['imdb']) { ?>
<div class="imdb">
<span>
...
<a href="<?php if($Listing['type'] == 'serie') { echo APP. '/show/'; } else { echo '/movie/'; } echo $Listing['self'] . '-' . $Listing['create_year'];?>" class="list-title">
