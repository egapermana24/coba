...
$adminconfig_file_path = "../app/config/router.config.php";
...
$adminconfig = file_get_contents($adminconfig_file_path);
$adminconfig = str_replace(
["A_PANEL"],
[
Input::cleaner($_POST['a_panel']),
],
$adminconfig
);
file_put_contents($adminconfig_file_path, $adminconfig); 


$adminconfig_file_path2 = "../.htaccess";
$adminconfig2 = file_get_contents($adminconfig_file_path2);
$adminconfig2 = str_replace(
["A_PANEL"],
[
Input::cleaner($_POST['a_panel']),
],
...
file_put_contents($adminconfig_file_path2, $adminconfig2); 


$adminconfig_file_path2 = "../app/config/menu.config.php";
$adminconfig2 = file_get_contents($adminconfig_file_path2);
$adminconfig2 = str_replace(
["A_PANEL"],
[
